...
public class Practice05ComposeShaderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap bitmapBatmanLogo = BitmapFactory.decodeResource(getResources(), R.drawable.batman_logo);
        BitmapShader shader1 = new BitmapShader(bitmapBatman, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        BitmapShader shader2 = new BitmapShader(bitmapBatmanLogo, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
